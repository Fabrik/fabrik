...
$this->group = $group;
	...
	foreach ($group->elements as $element) :
		if ($element->error !== '') :
			...
			$errorstyle = 'style="background:#EFE7B8 url(' . COM_FABRIK_LIVESITE_PATH .'media/com_fabrik/images/alert.png) no-repeat scroll left 7px !important;padding-left:40px;"';
			break;
		endif;
	endforeach;
	$c ++;
